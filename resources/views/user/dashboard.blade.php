...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="name" class="w-full p-2 border border-gray-300 rounded" value="{{ Auth::user()->name }}">
    </div>
    <div class="mb-4">
        <label class="block text-gray-700">Email</label>
        <input type="email" name="email" class="w-full p-2 border border-gray-300 rounded" value="{{ Auth::user()->email }}">
    </div>
    <div class="mb-4">
    ...
    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <form action="{{ route('profile.deactivate') }}" method="POST" style="display: inline;">
    @csrf
