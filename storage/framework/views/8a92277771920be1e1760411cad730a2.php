...
<a href="<?php echo e(route('posts.home')); ?>" class="text-white flex items-center hover:underline">
    ...
    <div class="mb-4">
        ...
        <input type="text" id="name" name="name" value="<?php echo e(old('name', isset($editProduct) ? $editProduct->name : '')); ?>" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring focus:ring-blue-500" placeholder="Enter product name">
    </div>
    <div class="mb-4">
        <label for="price" class="block text-sm font-medium text-gray-700">Price:</label>
        <input type="number" id="price" name="price" value="<?php echo e(old('price', isset($editProduct) ? $editProduct->price : '')); ?>" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring focus:ring-blue-500" placeholder="Enter product price">
    </div>
    <div class="mb-4">
        <label for="stock" class="block text-sm font-medium text-gray-700">Stock:</label>
        <input type="number" id="stock" name="stock" value="<?php echo e(old('stock', isset($editProduct) ? $editProduct->stock : '')); ?>" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring focus:ring-blue-500" placeholder="Enter stock quantity">
    </div>
    <div class="mb-4">
        ...
        <?php else: ?>
            <select id="category_id" name="category_id" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring focus:ring-blue-500">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($category->id); ?>" <?php echo e((old('category_id', isset($editProduct) ? $editProduct->category_id : '') == $category->id) ? 'selected' : ''); ?>>
...
<?php /**PATH C:\Users\abalo\midact3\resources\views/abaloschristianproduct.blade.php ENDPATH**/ ?>